...
#ifndef USE_SDL2
	SDL_Surface * CWriter::render_text ( std::string text, SDL_Color c, int type )
#else
...
*/
/*
SDL_Surface * CWriter::render_colored_text ( std::string text, SDL_Color color, int type=SOLID_TEXT )
{
	SText t;
	std::vector <SDL_Surface *> tmp;
	char error[512];
